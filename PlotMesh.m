...
switch elmtype
   ...
   case {'T10'}
      ...
      for i = 1:numel/6
         Q27el(i,:) = [...
            el(((i-1)*6+1),1), el(((i-1)*6+1),7), el(((i-1)*6+1),3),...
            el(((i-1)*6+1),5), el(((i-1)*6+1),6), el(((i-1)*6+2),5),...
            el(((i-1)*6+1),2), el(((i-1)*6+2),7), el(((i-1)*6+2),1),...
            el(((i-1)*6+3),7), el(((i-1)*6+3),6), el(((i-1)*6+4),7),...
            el(((i-1)*6+1),8), el(((i-1)*6+2),9), el(((i-1)*6+5),6),...
            el(((i-1)*6+1),9), el(((i-1)*6+2),8), el(((i-1)*6+5),5),...
            el(((i-1)*6+4),2), el(((i-1)*6+4),5), el(((i-1)*6+4),1),...
            el(((i-1)*6+4),9), el(((i-1)*6+4),8), el(((i-1)*6+6),7),...
            el(((i-1)*6+1),4), el(((i-1)*6+5),9), el(((i-1)*6+5),2)];
      end
